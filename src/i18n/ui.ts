...
export const ui = {
  en: {
    ...
    footer: {
      ...
      identity: 'Rogue Pixel — owned by Rubens Pessoa de Barros Filho.',
  ...
  'pt-br': {
    ...
    footer: {
      ...
      identity: 'Rogue Pixel — de Rubens Pessoa de Barros Filho.',
  ...
  de: {
    ...
    footer: {
      ...
      identity: 'Rogue Pixel — Inhaber: Rubens Pessoa de Barros Filho.',
